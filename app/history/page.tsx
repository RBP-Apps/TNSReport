...
export default function HistoryPage() {
  ...
  const openEditModal = (voucher: VoucherData) => {
...
const handleEditSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const voucherInfoData = [
      ...
      [
        { content: "VOUCHER NO:", styles: { fontStyle: 'bold', fillColor: colors.background.blue, textColor: colors.primary } },
        { content: editVoucher.voucherNo || "", styles: { fillColor: colors.background.blue } },
        { content: "DATE OF PAYMENT:", styles: { fontStyle: 'bold', fillColor: colors.background.blue, textColor: colors.primary } },
        { content: formatDate(editVoucher.dateOfPaymentProcess), styles: { fillColor: colors.background.blue } },
        { content: "TRANSACTION TYPE:", styles: { fontStyle: 'bold', fillColor: colors.background.blue, textColor: colors.primary } },
        { content: editVoucher.transactionType || "", styles: { fillColor: colors.background.blue, textColor: colors.accent, fontStyle: 'bold' } }
      ],
      // Row 2 - Bank & Company with yellow background
      [
        { content: "BANK A/C FROM:", styles: { fontStyle: 'bold', fillColor: colors.background.yellow, textColor: colors.primary } },
        { content: editVoucher.bankAcFrom || "", styles: { fillColor: colors.background.yellow } },
        { content: "COMPANY:", styles: { fontStyle: 'bold', fillColor: colors.background.yellow, textColor: colors.primary } },
        { content: editVoucher.companyName || "", styles: { fillColor: colors.background.yellow } },
        { content: "PURPOSE OF PAYMENT:", styles: { fontStyle: 'bold', fillColor: colors.background.yellow, textColor: colors.primary } },
      ...
      [
        { content: "PROJECT:", styles: { fontStyle: 'bold', fillColor: colors.background.green, textColor: colors.primary } },
        { content: editVoucher.project || "", styles: { fillColor: colors.background.green, textColor: colors.success, fontStyle: 'bold' } },
        { content: "BENEFICIARY NAME (PAID TO):", styles: { fontStyle: 'bold', fillColor: colors.background.green, textColor: colors.primary } },
        { content: editVoucher.beneficiaryName || "", styles: { fillColor: colors.background.green, colSpan: 3, fontStyle: 'bold' } },
        "",
        ""
      ],
      // Row 4 - Account Details with light blue background
      [
        { content: "PO NUMBER:", styles: { fontStyle: 'bold', fillColor: colors.background.blue, textColor: colors.primary } },
        { content: editVoucher.poNumber || "N/A", styles: { fillColor: colors.background.blue } },
        { content: "BENEFICIARY A/C NAME:", styles: { fontStyle: 'bold', fillColor: colors.background.blue, textColor: colors.primary } },
        { content: editVoucher.beneficiaryAcName || "", styles: { fillColor: colors.background.blue } },
        { content: "BENEFICIARY A/C NUMBER:", styles: { fontStyle: 'bold', fillColor: colors.background.blue, textColor: colors.primary } },
      ...
      [
        { content: "BENEFICIARY BANK NAME:", styles: { fontStyle: 'bold', fillColor: colors.background.light, textColor: colors.primary } },
        { content: editVoucher.beneficiaryBankName || "", styles: { fillColor: colors.background.light } },
        { content: "BENEFICIARY BANK IFSC:", styles: { fontStyle: 'bold', fillColor: colors.background.light, textColor: colors.primary } },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-blue-50">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 space-y-4 sm:space-y-6">
                      ...
                      <TableBody>
                        {filteredVouchers.map((voucher, index) => (
                          <TableRow key={voucher.id} className={`${index % 2 === 0 ? "bg-white" : "bg-gray-50"} hover:bg-blue-50 transition-colors`}>
                            ...
                            <TableCell className="text-xs lg:text-sm">{new Date(voucher.dateOfPaymentProcess).toLocaleDateString("en-IN")}</TableCell>
        ...
        {selectedVoucher && !isEditModalOpen && (
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 z-50">
            <Card className="bg-white w-full max-w-4xl max-h-[95vh] overflow-y-auto shadow-2xl">
              <CardHeader className="bg-gradient-to-r from-green-600 to-green-700 text-white">
                <CardTitle className="flex items-center justify-between text-sm sm:text-base">
                  <span>Edit Voucher - {editVoucher.voucherNo}</span>
                  <Button
                    variant="ghost"
                    size="sm"
              ...
              <CardContent className="p-3 sm:p-6 space-y-4 sm:space-y-6">
                <form onSubmit={handleEditSubmit}>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg mb-4">
                    <h4 className="font-semibold text-gray-800 mb-3 text-sm sm:text-base">Basic Information</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setEditVoucher({ ...editVoucher, transactionType: value })}
                        >
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setEditVoucher({ ...editVoucher, companyName: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Bank AC From</label>
                        <Input
                          value={editVoucher.bankAcFrom}
                          onChange={(e) => setEditVoucher({ ...editVoucher, bankAcFrom: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Date of Payment</label>
                        <Input
                          type="date"
                          ...
                          onChange={(e) =>
                            setEditVoucher({
                              ...editVoucher,
                              dateOfPaymentProcess: e.target.value
                            })
                          }
                          className="text-xs sm:text-sm"
                        />
                  ...
                  <div className="bg-green-50 p-4 rounded-lg mb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Purpose</label>
                        <Input
                          value={editVoucher.purposeOfPayment}
                          onChange={(e) => setEditVoucher({ ...editVoucher, purposeOfPayment: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setEditVoucher({ ...editVoucher, project: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">PO Number</label>
                        <Input
                          value={editVoucher.poNumber}
                          onChange={(e) => setEditVoucher({ ...editVoucher, poNumber: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Particulars</label>
                        <Input
                          value={editVoucher.particulars}
                          onChange={(e) => setEditVoucher({ ...editVoucher, particulars: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                    </div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg mb-4">
                    <h4 className="font-semibold text-gray-800 mb-3 text-sm sm:text-base">Beneficiary Details</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Beneficiary Name</label>
                        <Input
                          value={editVoucher.beneficiaryName}
                          onChange={(e) => setEditVoucher({ ...editVoucher, beneficiaryName: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">A/C Name</label>
                        <Input
                          value={editVoucher.beneficiaryAcName}
                          onChange={(e) => setEditVoucher({ ...editVoucher, beneficiaryAcName: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">A/C Number</label>
                        <Input
                          value={editVoucher.beneficiaryAcNumber}
                          onChange={(e) => setEditVoucher({ ...editVoucher, beneficiaryAcNumber: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          value={editVoucher.beneficiaryBankName}
                          onChange={(e) => setEditVoucher({ ...editVoucher, beneficiaryBankName: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Bank IFSC</label>
                        <Input
                          value={editVoucher.beneficiaryBankIfsc}
                          onChange={(e) => setEditVoucher({ ...editVoucher, beneficiaryBankIfsc: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                    </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg mb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Amount in Words</label>
                        <Input
                          value={editVoucher.amountInWords}
                          onChange={(e) => setEditVoucher({ ...editVoucher, amountInWords: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mb-4">
                    <h4 className="font-semibold text-gray-800 mb-3 text-sm sm:text-base">Approval Details</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Entry Done By</label>
                        <Input
                          value={editVoucher.entryDoneBy}
                          onChange={(e) => setEditVoucher({ ...editVoucher, entryDoneBy: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Checked By</label>
                        <Input
                          value={editVoucher.checkedBy}
                          onChange={(e) => setEditVoucher({ ...editVoucher, checkedBy: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Approved By</label>
                        <Input
                          value={editVoucher.approvedBy}
                          onChange={(e) => setEditVoucher({ ...editVoucher, approvedBy: e.target.value })}
                          className="text-xs sm:text-sm"
                        />
                      </div>
