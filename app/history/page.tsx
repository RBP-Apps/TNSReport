            ...
            <div className="p-6 sm:p-8">
              ...
              <form onSubmit={handleEditSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Date of Payment */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Date of Payment/Process</label>
                    <Input
                      type="date"
                  ...
                  {/* Purpose of Payment */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Purpose of Payment</label>
                    <Input
